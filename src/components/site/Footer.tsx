    ...
    <footer className="mt-24 border-t border-border bg-secondary/40">
      <div className="container-page grid gap-8 py-12 md:grid-cols-4">
        ...
        <div className="text-sm">
          ...
          <ul className="space-y-1 text-muted-foreground">
            <li><Link to="/apartments" className="hover:text-foreground">{t("cta.viewAll")}</Link></li>
          </ul>
        </div>
        <div className="text-sm">
          <div className="mb-2 font-medium">{t("nav.services")}</div>
          <ul className="space-y-1 text-muted-foreground">
            <li><Link to="/services" className="hover:text-foreground">{t("services.title")}</Link></li>
          </ul>
        </div>
        <div className="text-sm">
      ...
      <div className="border-t border-border">
        <div className="container-page flex flex-col items-start justify-between gap-2 py-4 text-xs text-muted-foreground md:flex-row md:items-center">
          ...
          <div><Link to="/admin" className="hover:text-foreground">{t("nav.admin")}</Link></div>
        </div>
      </div>
    </footer>
  );
