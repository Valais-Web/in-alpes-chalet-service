...
export function ApartmentCard({ apartment }: { apartment: Apartment }) {
  ...
  return (
    <Link
      ...
      className="group card-soft overflow-hidden transition-shadow hover:shadow-[var(--shadow-lift)]"
    >
      ...
      <div className="p-5">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
          <span className="inline-flex items-center gap-1"><Users className="h-3.5 w-3.5" />{apartment.maxGuests}</span>
          <span className="inline-flex items-center gap-1"><BedDouble className="h-3.5 w-3.5" />{apartment.bedrooms}</span>
          <span className="inline-flex items-center gap-1"><Bath className="h-3.5 w-3.5" />{apartment.bathrooms}</span>
          <span className="inline-flex items-center gap-1"><Ruler className="h-3.5 w-3.5" />{apartment.surfaceM2} m²</span>
        </div>
